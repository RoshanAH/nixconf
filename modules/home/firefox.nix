...
let
  ...
  passff-host-custom = pkgs.passff-host.overrideAttrs (old: {
    dontStrip = true;
    patchPhase = ''
...
in
{
  xdg.configFile."mozilla/native-messaging-hosts/passff.json".source =
    "${passff-host-custom}/share/passff-host/passff.json";
